...
import { oeaCardReveal } from '@/lib/animations'
...
export default function About() {
  ...
  const oeaRef = useRef<HTMLDivElement>(null)

  useScrollAnimations(containerRef)

  useGSAP(() => {
    if (!oeaRef.current) return
    oeaCardReveal(oeaRef.current)
  }, { scope: oeaRef })
    ...
    <div ref={containerRef}>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          ...
          <h2 data-heading-reveal className="font-['Playfair_Display'] text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-900 mb-8 max-w-3xl leading-tight">
            De Puerta a Puerta
          </h2>
          <p data-para-reveal className="text-zinc-600 text-lg leading-relaxed max-w-4xl">
      ...
      <section className="py-24 lg:py-32 bg-[#fafaf8]">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          ...
          {/* Misión + Visión row */}
          <div data-card-3d-group className="grid md:grid-cols-2 gap-8 lg:gap-12 mt-4">
            <div data-card-3d className="bg-white p-8 lg:p-10 shadow-sm border border-zinc-100">
          ...
          {/* Valores — full width below */}
          <div data-card-3d-group className="mt-8 lg:mt-12">
            <div data-card-3d className="bg-zinc-900 p-8 lg:p-12">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 flex items-center justify-center bg-[#c41e3a] text-white shrink-0">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-5">
                {valores.map((v, i) => (
                  <div key={i} className="flex gap-3">
                    ...
                    <span className="text-zinc-300 text-[15px] leading-relaxed">{v}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          ...
          <div className="max-w-4xl space-y-6">
            <p data-para-reveal className="text-zinc-600 text-lg leading-relaxed">
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div ref={oeaRef} data-oea-card className="bg-zinc-900 p-10 lg:p-16 flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            <div className="flex-shrink-0" data-oea-icon>
